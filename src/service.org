...
#+begin_src nim :noweb-ref egg-lock-on-confirm
  ...
  discard await redis_client.setEx("egg-lock-on-ack." & $uid & "." & $param.pin, 10, $param.timestamp)
  for taskstr in taskstrs:
    let task = try: parseJson(taskstr) except: nil
...
#+begin_src nim :noweb-ref egg-lock-off-confirm
  ...
  discard await redis_client.setEx("egg-lock-off-ack." & $uid & "." & $param.pin, 10, $param.timestamp)
  let taskstrs: seq[string] = await redis_client.lrange(taskkey, 0, -1)
  for taskstr in taskstrs:
    let task = try: parseJson(taskstr) except: nil
...
#+begin_src nim :noweb-ref egg-play-confirm
  ...
  discard await redis_client.setEx("egg-play-ack." & $uid & "." & $param.pin, 10, $param.timestamp)
  for taskstr in taskstrs:
    let task = try: parseJson(taskstr) except: nil
...
#+begin_src nim :noweb-ref egg-gpio-confirm
  ...
  discard await redis_client.setEx("egg-gpio-ack." & $uid & "." & $param.pin, 10, $param.timestamp)
  for taskstr in taskstrs:
    let task = try: parseJson(taskstr) except: nil
...
#+begin_src nim :noweb-ref egg-volume-confirm
  ...
  discard await redis_client.setEx("egg-volume-ack." & $uid & "." & $param.pin, 10, $param.timestamp)
  for taskstr in taskstrs:
    let task = try: parseJson(taskstr) except: nil
...
info "Confirm cmd type is egg-query, egg: ", param.board, ", cabin: ", param.lock
  discard await redis_client.setEx("egg-query-ack." & $uid & "." & $param.pin, 10, $param.timestamp)
  for taskstr in taskstrs:
    let task = try: parseJson(taskstr) except: nil
