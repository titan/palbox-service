...
#+begin_src nim :noweb-ref confirm
  ...
  let
    ...
    cmd_type = case param.cmd_type:
                 ...
                 of 9: CommandType.LIGHT_ON
                 of 10: CommandType.LIGHT_OFF
                 of 11: CommandType.FAN_ON
                 of 12: CommandType.FAN_OFF
...
#+begin_src nim :exports code :noweb yes :mkdirp yes :tangle /dev/shm/box-service/src/box_servicepkg/box_packer.nim
  ...
  type
    CommandType* {.pure.} = enum
      UNKNOWN = 0, PING = 1, PONG = 2, CONFIRM = 3, LOCK_OFF = 4, LOCKS_OFF = 5, LOCK_STATUS = 6, LOCK_DETECT = 7, CHARGER_STATUS = 8, LIGHT_ON = 9, LIGHT_OFF = 10, FAN_ON = 11, FAN_OFF = 12, ULTRAVIOLET_ON = 13, ULTRAVIOLET_OFF = 14, CAMERA_ON = 15, CAMERA_OFF = 16
    UID* = array[0..11, byte]
