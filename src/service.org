...
#+begin_src nim :noweb-ref ping
  ...
  await redis_client.setk(ping_key, $gprs_shutdown & "," & $gprs_reset)
  <<pong>>
#+end_src
* PONG
...
#+begin_src nim :noweb-ref lock-off-confirm
  ...
  for taskstr in taskstrs:
    let task = try: parseJson(taskstr) except: nil
    if task != nil and task["command"].getStr() == "lock-off" and cast[int8](task["board"].getNum()) == param.board and cast[int8](task["lock"].getNum()) == param.lock and cast[int16](task["pin"].getNum()) == param.pin:
      <<remove-task>>
#+end_src
* LOCKS-OFF
** 下行命令
...
#+begin_src nim :noweb-ref lock-detect-confirm
  ...
  for taskstr in taskstrs:
    let task = try: parseJson(taskstr) except: nil
    if task != nil and task["command"].getStr() == "lock-detect" and cast[int8](task["board"].getNum()) == param.board and cast[int16](task["pin"].getNum()) == param.pin:
      <<remove-task>>
#+end_src
* LOCK-STATUS-DETECT
** 下行命令
...
#+begin_src nim :noweb-ref lock-status-detect-confirm
  ...
  for taskstr in taskstrs:
    let task = try: parseJson(taskstr) except: nil
    if task != nil and task["command"].getStr() == "lock-status-detect" and cast[int8](task["board"].getNum()) == param.board and cast[int16](task["pin"].getNum()) == param.pin:
      <<remove-task>>
#+end_src
* LOCK-DATA
...
#+begin_src nim :noweb-ref light-on-confirm
  ...
  for taskstr in taskstrs:
    let task = try: parseJson(taskstr) except: nil
    if task != nil and task["command"].getStr() == "light-on" and cast[int16](task["pin"].getNum()) == param.pin:
      <<remove-task>>
#+end_src
* LIGHT-OFF
** 下行命令
...
#+begin_src nim :noweb-ref light-off-confirm
  ...
  for taskstr in taskstrs:
    let task = try: parseJson(taskstr) except: nil
    if task != nil and task["command"].getStr() == "light-off" and cast[int16](task["pin"].getNum()) == param.pin:
      <<remove-task>>
#+end_src
* FAN-ON
** 下行命令
...
#+begin_src nim :noweb-ref fan-on-confirm
  ...
  for taskstr in taskstrs:
    let task = try: parseJson(taskstr) except: nil
    if task != nil and task["command"].getStr() == "fan-on" and cast[int16](task["pin"].getNum()) == param.pin:
      <<remove-task>>
#+end_src
* FAN-OFF
** 下行命令
...
#+begin_src nim :noweb-ref fan-off-confirm
  ...
  for taskstr in taskstrs:
    let task = try: parseJson(taskstr) except: nil
    if task != nil and task["command"].getStr() == "fan-off" and cast[int16](task["pin"].getNum()) == param.pin:
      <<remove-task>>
#+end_src
* ULTRAVIOLET-ON
** 下行命令
...
#+begin_src nim :noweb-ref ultraviolet-on-confirm
  ...
  for taskstr in taskstrs:
    let task = try: parseJson(taskstr) except: nil
    if task != nil and task["command"].getStr() == "ultraviolet-on" and cast[int16](task["pin"].getNum()) == param.pin:
      <<remove-task>>
#+end_src
* ULTRAVIOLET-OFF
** 下行命令
...
#+begin_src nim :noweb-ref ultraviolet-off-confirm
  ...
  for taskstr in taskstrs:
    let task = try: parseJson(taskstr) except: nil
    if task != nil and task["command"].getStr() == "ultraviolet-off" and cast[int16](task["pin"].getNum()) == param.pin:
      <<remove-task>>
#+end_src
...
#+begin_src nim :noweb-ref camera-on-confirm
  ...
  for taskstr in taskstrs:
    let task = try: parseJson(taskstr) except: nil
    if task != nil and task["command"].getStr() == "camera-on" and cast[int16](task["pin"].getNum()) == param.pin:
      <<remove-task>>
#+end_src
* CAMERA-OFF
** 下行命令
...
#+begin_src nim :noweb-ref camera-off-confirm
  ...
  for taskstr in taskstrs:
    let task = try: parseJson(taskstr) except: nil
    if task != nil and task["command"].getStr() == "camera-off" and cast[int16](task["pin"].getNum()) == param.pin:
      <<remove-task>>
#+end_src
...
#+begin_src nim :noweb-ref charger-status-confirm
  ...
  for taskstr in taskstrs:
    let task = try: parseJson(taskstr) except: nil
    if task != nil and task["command"].getStr() == "charger-status" and cast[int16](task["pin"].getNum()) == param.pin:
      <<remove-task>>
#+end_src
* PLAY
** 下行命令
