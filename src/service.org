...
#+begin_src nim :noweb-ref confirm
  ...
  let
    ...
    cmd_type = case param.cmd_type:
                 ...
                 of 8: CommandType.CHARGER_STATUS
                 of 9: CommandType.INSIDE_LIGHT_ON
                 of 10: CommandType.INSIDE_LIGHT_OFF
                 of 11: CommandType.OUTSIDE_LIGHT_ON
                 of 12: CommandType.OUTSIDE_LIGHT_OFF
                 of 13: CommandType.ULTRAVIOLET_ON
                 of 14: CommandType.ULTRAVIOLET_OFF
                 of 15: CommandType.CAMERA_ON
                 of 16: CommandType.CAMERA_OFF
...
#+begin_src nim :exports code :noweb yes :mkdirp yes :tangle /dev/shm/box-service/src/box_servicepkg/box_packer.nim
  ...
  type
    CommandType* {.pure.} = enum
      UNKNOWN = 0, PING = 1, PONG = 2, CONFIRM = 3, LOCK_OFF = 4, LOCKS_OFF = 5, LOCK_STATUS = 6, LOCK_DETECT = 7, CHARGER_STATUS = 8, INSIDE_LIGHT_ON = 9, INSIDE_LIGHT_OFF = 10, OUTSIDE_LIGHT_ON = 11, OUTSIDE_LIGHT_OFF = 12, ULTRAVIOLET_ON = 13, ULTRAVIOLET_OFF = 14, CAMERA_ON = 15, CAMERA_OFF = 16
    UID* = array[0..11, byte]
